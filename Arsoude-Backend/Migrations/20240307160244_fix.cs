    ...
    public partial class fix : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "11111111-1111-1111-1111-111111111113", "6ca717bb-22ff-42b9-86af-897a2fb3402a", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "11111111-1111-1111-1111-111111111111", 0, "a9d7a029-70ac-404d-a378-9785d24275e1", "admin@admin.com", true, false, null, "ADMIN@ADMIN.COM", "ADMIN@ADMIN.COM", "AQAAAAEAACcQAAAAEEWYghfdO4xV1kRASyV4YBMnzfPMx6fwwAqgcHVjBSqcHhdoNXFjwIZmag2PAjqy5g==", null, false, "1d92adac-8fa5-4978-8f75-16d12c12bac9", false, "admin@admin.com" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "11111111-1111-1111-1111-111111111112", 0, "7b8d66b7-2a76-4e93-83e2-693e7220255c", "user@user.com", true, false, null, "USER@USER.COM", "USER@USER.COM", "AQAAAAEAACcQAAAAELzZIIPxyVCFbc8U+eZMgibzBxbzHUQ3JS7REGZAMNQKdDcdRxlvRL0lCn6MXaGW7A==", null, false, "58e05541-dbb2-4fa2-b9bb-e1072dfa1276", false, "user@user.com" });
            ...
            migrationBuilder.InsertData(
                table: "Trails",
                columns: new[] { "Id", "CreationDate", "Description", "Distance", "EndingCoordinatesId", "ImageUrl", "IsApproved", "Location", "Name", "OwnerId", "StartingCoordinatesId", "Type", "UserId", "isPublic" },
            ...
            migrationBuilder.InsertData(
                table: "Trails",
                columns: new[] { "Id", "CreationDate", "Description", "Distance", "EndingCoordinatesId", "ImageUrl", "IsApproved", "Location", "Name", "OwnerId", "StartingCoordinatesId", "Type", "UserId", "isPublic" },
                values: new object[] { 34, null, "Une aventure à travers les ruines anciennes d'une civilisation disparue, où vous pourrez découvrir l'histoire fascinante de ce site archéologique. Ce sentier offre une expérience immersive dans le passé, avec des vestiges bien préservés et des paysages à couper le souffle qui témoignent de la grandeur passée de cette civilisation.", null, 2, "https://i.cbc.ca/1.4170049.1530218327!/fileImage/httpImage/hiking-trails.jpg", true, "Site Archéologique des Ruines Anciennes", "Sentier des Ruines Anciennes", 1, 1, 0, null, true });

            migrationBuilder.InsertData(
                table: "Trails",
                columns: new[] { "Id", "CreationDate", "Description", "Distance", "EndingCoordinatesId", "ImageUrl", "IsApproved", "Location", "Name", "OwnerId", "StartingCoordinatesId", "Type", "UserId", "isPublic" },
                values: new object[] { 35, null, "Une randonnée le long de falaises côtières majestueuses, offrant des vues spectaculaires sur l'océan et les côtes rocheuses. Ce sentier offre une expérience unique en bord de mer, avec des panoramas à couper le souffle et une ambiance maritime rafraîchissante.", null, 2, "https://www.mississauga.ca/wp-content/uploads/2022/10/14143203/20221010_115918-scaled.jpg", true, "Falaises Côtières", "Randonnée des Falaises Côtières", 1, 1, 0, null, true });
